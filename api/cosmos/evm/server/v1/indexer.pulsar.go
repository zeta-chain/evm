...
func init() {
	file_cosmos_evm_server_v1_indexer_proto_init()
	md_TxResult = File_cosmos_evm_server_v1_indexer_proto.Messages().ByName("TxResult")
...
func (x *TxResult) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_evm_server_v1_indexer_proto_msgTypes[0]
...
func (x *fastReflection_TxResult) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.evm.server.v1.TxResult.height":
		return x.Height != int64(0)
	case "cosmos.evm.server.v1.TxResult.tx_index":
		return x.TxIndex != uint32(0)
	case "cosmos.evm.server.v1.TxResult.msg_index":
		return x.MsgIndex != uint32(0)
	case "cosmos.evm.server.v1.TxResult.eth_tx_index":
		return x.EthTxIndex != int32(0)
	case "cosmos.evm.server.v1.TxResult.failed":
		return x.Failed != false
	case "cosmos.evm.server.v1.TxResult.gas_used":
		return x.GasUsed != uint64(0)
	case "cosmos.evm.server.v1.TxResult.cumulative_gas_used":
		return x.CumulativeGasUsed != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.server.v1.TxResult"))
		}
		panic(fmt.Errorf("message cosmos.evm.server.v1.TxResult does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TxResult) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.evm.server.v1.TxResult does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TxResult) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.evm.server.v1.TxResult.height":
		panic(fmt.Errorf("field height of message cosmos.evm.server.v1.TxResult is not mutable"))
	case "cosmos.evm.server.v1.TxResult.tx_index":
		panic(fmt.Errorf("field tx_index of message cosmos.evm.server.v1.TxResult is not mutable"))
	case "cosmos.evm.server.v1.TxResult.msg_index":
		panic(fmt.Errorf("field msg_index of message cosmos.evm.server.v1.TxResult is not mutable"))
	case "cosmos.evm.server.v1.TxResult.eth_tx_index":
		panic(fmt.Errorf("field eth_tx_index of message cosmos.evm.server.v1.TxResult is not mutable"))
	case "cosmos.evm.server.v1.TxResult.failed":
		panic(fmt.Errorf("field failed of message cosmos.evm.server.v1.TxResult is not mutable"))
	case "cosmos.evm.server.v1.TxResult.gas_used":
		panic(fmt.Errorf("field gas_used of message cosmos.evm.server.v1.TxResult is not mutable"))
	case "cosmos.evm.server.v1.TxResult.cumulative_gas_used":
		panic(fmt.Errorf("field cumulative_gas_used of message cosmos.evm.server.v1.TxResult is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.server.v1.TxResult"))
		}
...
func (x *fastReflection_TxResult) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.evm.server.v1.TxResult", d.FullName()))
	}
	panic("unreachable")
}
...
func (*TxResult) Descriptor() ([]byte, []int) {
	return file_cosmos_evm_server_v1_indexer_proto_rawDescGZIP(), []int{0}
}
...
var File_cosmos_evm_server_v1_indexer_proto protoreflect.FileDescriptor

var file_cosmos_evm_server_v1_indexer_proto_rawDesc = []byte{
	0x0a, 0x22, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x72, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x14, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0xe5, 0x01, 0x0a, 0x08, 0x54, 0x78, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x16, 0x0a,
	...
	0x65, 0x64, 0x3a, 0x04, 0x88, 0xa0, 0x1f, 0x00, 0x42, 0xcb, 0x01, 0x0a, 0x18, 0x63, 0x6f, 0x6d,
	0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x72, 0x50, 0x72,
	...
	,
}

var (
	file_cosmos_evm_server_v1_indexer_proto_rawDescOnce sync.Once
	file_cosmos_evm_server_v1_indexer_proto_rawDescData = file_cosmos_evm_server_v1_indexer_proto_rawDesc
)

func file_cosmos_evm_server_v1_indexer_proto_rawDescGZIP() []byte {
	file_cosmos_evm_server_v1_indexer_proto_rawDescOnce.Do(func() {
		file_cosmos_evm_server_v1_indexer_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_evm_server_v1_indexer_proto_rawDescData)
	})
	return file_cosmos_evm_server_v1_indexer_proto_rawDescData
}

var file_cosmos_evm_server_v1_indexer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_cosmos_evm_server_v1_indexer_proto_goTypes = []interface{}{
	(*TxResult)(nil), // 0: cosmos.evm.server.v1.TxResult
}
var file_cosmos_evm_server_v1_indexer_proto_depIdxs = []int32{
...
func init() { file_cosmos_evm_server_v1_indexer_proto_init() }
func file_cosmos_evm_server_v1_indexer_proto_init() {
	if File_cosmos_evm_server_v1_indexer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_evm_server_v1_indexer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_evm_server_v1_indexer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		...
		MessageInfos:      file_cosmos_evm_server_v1_indexer_proto_msgTypes,
	}.Build()
	File_cosmos_evm_server_v1_indexer_proto = out.File
	file_cosmos_evm_server_v1_indexer_proto_rawDesc = nil
	file_cosmos_evm_server_v1_indexer_proto_goTypes = nil
	file_cosmos_evm_server_v1_indexer_proto_depIdxs = nil
}
