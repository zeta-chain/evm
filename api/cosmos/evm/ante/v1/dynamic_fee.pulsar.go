...
func init() {
	file_cosmos_evm_ante_v1_dynamic_fee_proto_init()
	md_ExtensionOptionDynamicFeeTx = File_cosmos_evm_ante_v1_dynamic_fee_proto.Messages().ByName("ExtensionOptionDynamicFeeTx")
...
func (x *ExtensionOptionDynamicFeeTx) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_evm_ante_v1_dynamic_fee_proto_msgTypes[0]
...
func (x *fastReflection_ExtensionOptionDynamicFeeTx) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx.max_priority_price":
		return x.MaxPriorityPrice != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx"))
		}
		panic(fmt.Errorf("message cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionDynamicFeeTx) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionDynamicFeeTx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx.max_priority_price":
		panic(fmt.Errorf("field max_priority_price of message cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx"))
		}
...
func (x *fastReflection_ExtensionOptionDynamicFeeTx) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx", d.FullName()))
	}
	panic("unreachable")
}
...
func (*ExtensionOptionDynamicFeeTx) Descriptor() ([]byte, []int) {
	return file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescGZIP(), []int{0}
}
...
var File_cosmos_evm_ante_v1_dynamic_fee_proto protoreflect.FileDescriptor

var file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDesc = []byte{
	0x0a, 0x24, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x61, 0x6e, 0x74,
	0x65, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x5f, 0x66, 0x65, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65,
	0x76, 0x6d, 0x2e, 0x61, 0x6e, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e,
	...
	0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x76, 0x6d, 0x2e, 0x61, 0x6e,
	0x74, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x0f, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x46, 0x65,
	...
	,
}

var (
	file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescOnce sync.Once
	file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescData = file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDesc
)

func file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescGZIP() []byte {
	file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescOnce.Do(func() {
		file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescData)
	})
	return file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDescData
}

var file_cosmos_evm_ante_v1_dynamic_fee_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_cosmos_evm_ante_v1_dynamic_fee_proto_goTypes = []interface{}{
	(*ExtensionOptionDynamicFeeTx)(nil), // 0: cosmos.evm.ante.v1.ExtensionOptionDynamicFeeTx
}
var file_cosmos_evm_ante_v1_dynamic_fee_proto_depIdxs = []int32{
...
func init() { file_cosmos_evm_ante_v1_dynamic_fee_proto_init() }
func file_cosmos_evm_ante_v1_dynamic_fee_proto_init() {
	if File_cosmos_evm_ante_v1_dynamic_fee_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_evm_ante_v1_dynamic_fee_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_evm_ante_v1_dynamic_fee_proto_goTypes,
		DependencyIndexes: file_cosmos_evm_ante_v1_dynamic_fee_proto_depIdxs,
		MessageInfos:      file_cosmos_evm_ante_v1_dynamic_fee_proto_msgTypes,
	}.Build()
	File_cosmos_evm_ante_v1_dynamic_fee_proto = out.File
	file_cosmos_evm_ante_v1_dynamic_fee_proto_rawDesc = nil
	file_cosmos_evm_ante_v1_dynamic_fee_proto_goTypes = nil
	file_cosmos_evm_ante_v1_dynamic_fee_proto_depIdxs = nil
}
