...
func (k Keeper) RegisterERC20CodeHash(ctx sdk.Context, erc20Addr common.Address) error {
	...
	if acc := k.evmKeeper.GetAccount(ctx, erc20Addr); acc != nil { // can use spendable or total
		nonce = acc.Nonce
		balance = acc.Balance
	}
...
func (k Keeper) UnRegisterERC20CodeHash(ctx sdk.Context, erc20Addr common.Address) error {
	...
	return k.evmKeeper.SetAccount(ctx, erc20Addr, statedb.Account{ // can use spendable or total
