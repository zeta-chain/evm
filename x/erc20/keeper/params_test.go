	...
	testCases := []struct {
	...
	}{
		{
			...
			func() interface{} {
				...
				erc20Params.NativePrecompiles[testconstants.WEVMOSContractMainnet] = true
		...
		},
		{
			...
			func() interface{} {
				...
				params.DynamicPrecompiles = map[string]bool{"0xB5124FA2b2cF92B2D469b249433BA1c96BDF536D": true, "0xC4CcDf91b810a61cCB48b35ccCc066C63bf94B4F": true}
		...
		},
		{
			...
			func() interface{} {
				params := types.DefaultParams()
				params.NativePrecompiles = map[string]bool{"0x205CF44075E77A3543abC690437F3b2819bc450a": true, "0x8FA78CEB7F04118Ec6d06AaC37Ca854691d8e963": true}
				err := suite.network.App.Erc20Keeper.SetParams(ctx, params)
				suite.Require().NoError(err)
